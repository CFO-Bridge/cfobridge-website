<div class="main-panel">
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                            ...
                            <td>
                            <a class="btn btn-primary" href="<?=base_url("admin/locationgallery/{$row['id']}")?>" >View</a>
                            </td>
                    <!--   <td><input type="checkbox" class="form-check-input featured-service" data-id="<?= $row['id'] ?>" <?=($row['fservice'] == 1) ? "checked" : ""?>></td>
                     -->  <td>
                        <a class="text-primary mr-5" href="<?= base_url('admin/editlocation/') . $row['id'] ?>"><i class="fa fa-edit"></i></a>
  ...
  <script>
    $('.delete').click(function() {
      ...
      let bclass = $(this);
      $.ajax({
        url: site_url + "admin/deletelocation",
        type: "POST",
        data: {
          id: id
        },
    ...
    $('.change-status').click(function() {
      ...
      id = $(this).data('id');
      $.ajax({
        url: site_url + "admin/changelocationstatus",
        type: "POST",
        data: {
          id: id
        },
