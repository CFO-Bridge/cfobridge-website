<?php if(!empty($pserv['bannerCounterArr']))
                {
                   ...
                   ?>
 <div class="vf-wrap">
                        <img src="<?=base_url("uploads/images/{$arr['image']}")?>" alt="<?=$arr['image']?>">
                        <div>
                            <h3><?=$arr['label']?></h3>
                            <p><?=$arr['count']?></p>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="inp-grp">
                                        <div class="select-grp">
                                            ...
                                            <img src="<?= base_url() ?>assets/images/arrow.svg" alt="Arrow icon">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <?php if(!empty($pserv['keybenefitsArr']))
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="service-card-one">
                        <div class="row">
                            <div class="col-auto d-flex justify-content-center align-items-center  service_card_icon">
                            <img src="<?=base_url("uploads/images/{$row['heading']}.png")?>" width="40px" alt="<?=$row['heading']?>">
                            </div>
                            <div class="col service_card_content">
                                <div class="service_card_title">
                                    <h3><?=$row['heading']?></h3>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
               ...
               <img src="<?=base_url("uploads/images/{$pserv['serviceworks_image']}")?>" width="65%" alt="<?=$pserv['serviceworks_image']?>" style="border-radius: 10px;">
               </div>
            </div>
        </div>
        <div class="row row-gap-25 mt-50">
                    ...
                    <div class="row">
                        <div class="d-flex justify-content-center align-items-center "> 
                            <div class="service_card_two_icon  d-flex justify-content-center align-items-center  ">
                                <img src="<?=base_url("uploads/images/{$row['heading']}.png")?>" width="50px" alt="<?=$row['heading']?>">
                            </div>
                        </div>
...
<section class="what-sec sec">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <div class="help-points-grid grid-2">
...
<section class="sec uni-sec light-bg">
    <img src="<?=base_url('assets/images/path.svg')?>" alt="path.svg">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="sec-head center">
